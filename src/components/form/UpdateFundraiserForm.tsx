...
function UpdateFundraiserForm({
    ...
    const handleRemoveFile = (index: number) => {
        setFormData((prev) => ({
            ...prev,
            supportingImages: prev.supportingImages.filter(
                (_, i) => i !== index,
            ),
        }));
    };
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <TextField
                                ...
                                helperText={
                                    ...
                                    "Ví dụ: Giáo dục, Y Tế, Văn hoá, Đời sống,..."
                                }
                                sx={{ mb: 3 }}
                                required
                            ...
                            <TextField
                                ...
                                helperText={
                                    ...
                                    "Ví dụ: Toàn quốc, Thành phố Hồ Chí Minh, Khu vực miền Trung"
                                }
                                sx={{ mb: 3 }}
                                required
                            ...
                            <FormControl fullWidth sx={{ mb: 3 }}>
                                ...
                                >
                                    Sơ yếu lý lịch, giấy phép hoạt động, mạng xã
                                    hội, hoặc các tài liệu chứng minh khác
                                </Typography>
                                ...
                                <Button
                                    ...
                                    sx={{
                                        borderColor: errors.supportingImages
                                            ? "#d32f2f"
                                            : "#0d9488",
                                        color: errors.supportingImages
                                            ? "#d32f2f"
                                            : "#0d9488",
                                        "&:hover": {
                                            borderColor: errors.supportingImages
                            ...
                            {submitStatus === "success" && (
                                <Alert severity="success" sx={{ mb: 3 }}>
                                    Đăng ký thành công! Chúng tôi sẽ xem xét và
